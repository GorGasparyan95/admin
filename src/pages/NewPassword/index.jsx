...
const NewPassword = ({ change }) => {
    ...
    return (
        <div className='wrapper' style={change ? { height: '100%' } : {}}>
            ...
            <form noValidate onSubmit={handleSubmit} >
                <div className='col_2'>
                    <div className='input_wrap' style={!change ? {} : change && (errors.newPwd || errors.confirm) ? { width: '230px', gap: '4px' } : { width: '230px' }}>
                        <input
                    ...
                    <button className='main_btn' type="submit">{change ? 'Save' : 'Sign In'}</button>
                </div>
            </form>
        </div>
    )
